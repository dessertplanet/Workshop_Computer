export const infoYamlSchema = {
  ...
  fields: [
    ...
    { path: 'Name', type: 'string', required: true, description: 'Display title for the card.' },
    ...
    { path: 'date', type: 'string', required: false, description: 'Last update date in YYYY-MM-DD form.' },
