...
| 67_Fragments | Six-slot audio recorder and clocked fragment sequencer with browser librarian, MIDI pitch control, random CV outputs, and an alternate long-sample variation mode.<br>[Web editor](https://github.com/TomWhitwell/Workshop_Computer/blob/main/releases/67_Fragments/web/fragments_librarian.html) | 1.0<br>Released | C++ (RPi Pico SDK) | Max Harnishfeger |
