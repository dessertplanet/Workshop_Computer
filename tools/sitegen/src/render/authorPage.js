  ...
  <main class="author-page${existing ? ' is-loading' : ''}" data-document-kind="${documentKind}">
    ...
    <div class="author-workspace">
      ...
      <section id="yaml-editor" class="author-yaml" aria-label="Advanced YAML editor"${existing ? '' : ' hidden'}>
        ...
        <div class="author-editor-wrap"><div class="author-editor-gutter" aria-hidden="true"><div id="gutter-inner">1</div></div><div class="author-editor-code"><pre id="yaml-highlight" aria-hidden="true"></pre><textarea id="yaml-source" wrap="off" spellcheck="false" autocapitalize="off" autocorrect="off" autocomplete="off" aria-label="Raw info.yaml source"></textarea><div id="yaml-diagnostic-tooltip" class="yaml-diagnostic-tooltip" role="tooltip" hidden></div></div></div>
      </section>
