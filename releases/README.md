...
| 16_The_Bells | A sequencer that provides 12 bell ringing methods with tempo and jitter controls, quantised to six different scales. | 1.0 <br>Released | C++ (ComputerCard) | James Saunders |
