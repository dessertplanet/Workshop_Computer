...
| 61_ZX_Spectrum | A cycle-accurate ZX Spectrum 128K that turns the modular jacks/knobs/switch into a patchable control surface — plus OneBit (1-bit beeper synth) as an alternate boot mode. | 1.0.0<br>Released | C++ (Pico SDK / ComputerCard) | Andy Jenkinson (uglifruit) |
