...
// Bitwise AND cross-modulation:
// Convert to int16, AND them, blend with sum based on parameter
inline int32_t process_and_q15(int32_t x1_q15, int32_t x2_q15, int32_t parameter_q15) {
    ...
    // AND the bits
    int16_t and_result = x1_short & x2_short;
    int32_t mod_q15 = static_cast<int32_t>(and_result);
