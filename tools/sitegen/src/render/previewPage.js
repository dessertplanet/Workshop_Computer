...
<head>
  ...
  <style>
    ...
    #yaml-source{width:100%;height:60vh;box-sizing:border-box;margin-top:8px;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-size:13px;line-height:1.5;padding:10px;border:1px solid var(--border,#ccc);border-radius:8px;resize:vertical;white-space:pre;tab-size:2}
