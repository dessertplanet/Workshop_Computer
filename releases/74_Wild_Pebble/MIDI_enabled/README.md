...
MIDI-enabled variant of Wild Pebble for the Music Thing Modular Workshop Computer.

This folder is a separate build of the card. The original `WildPebble.cpp` in the parent folder is left untouched.
...
This variant adds USB MIDI device support.
...
This is an AI-assisted MIDI variant based on the original Wild Pebble card.
...
The analogue behavior remains the same as the original Wild Pebble unless MIDI clock is connected and running.
