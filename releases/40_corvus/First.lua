--- unique melody box
-- each ComputerCard sings its own song
-- adapted from crow First.lua for Workshop Computer
...
function init()
  -- generate unique tables using ComputerCard's unique ID
  lcg(computer_card_unique_id())
  lcg()
  lcg()
  lcg()
