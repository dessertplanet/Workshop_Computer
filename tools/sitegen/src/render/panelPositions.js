...
export const panelPositions = {
  controls: [
    { key: 'main', left: 48.9, top: 15.1 },
    { key: 'x', left: 15.7, top: 32.6 },
    { key: 'y', left: 48.7, top: 32.6 },
    { key: 'z', left: 81.6, top: 32.6 },
  ],
  inputs: [
    { key: 'audio_l', name: 'Audio / CV L', left: 10.9, top: 46.1 },
    { key: 'audio_r', name: 'Audio / CV R', left: 36.1, top: 46.1 },
  ...
  outputs: [
    { key: 'audio_out_l', name: 'Audio / CV L', left: 61.3, top: 46.1 },
    { key: 'audio_out_r', name: 'Audio / CV R', left: 86.5, top: 46.1 },
