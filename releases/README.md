...
| 34_dual_quant | Dual quantised granular pitch shifter with calibrated 1V/oct CV outputs | 1.0<br>Beta - stable in single-developer testing | C++ (ComputerCard / Pico SDK) | Adrian Vos |
...
| 433_sense_of_space | Whimsical 4'33"-inspired ambience looper with a three-loop transport, LED countdown, restlessness fidgets, Pulse In restart, and chair creak one-shot. | 0.2.1<br>Beta - stable in single-developer testing | C++ (Pico SDK / ComputerCard) | Adrian Vos |
| 43_Castle_Process | Fort Processor-inspired harsh noise processor with chopped external audio and a bass pulse voice | 1.0<br>Beta - stable in single-developer testing | C++ | Adrian Vos |
...
| 58_LoChoVibes | Stereo chorus and vibrato effect featuring triangle, sine, and slow drift LFO modes, modulation-based delay movement, and tape-style saturation. | 0.1.0<br>Beta - stable in single-developer testing | C++ | Adrian Vos |
| 59_BitPhase | Resonant 4-stage phaser for the Workshop Computer with deep notch filtering, wide modulation sweeps, controllable resonance, tremolo blending, and digital Burst-mode degradation. | 0.1.0<br>Beta - stable in single-developer testing | C++ (Pico SDK) | Adrian Vos |
...
| 61_ZX_Spectrum | A cycle-accurate ZX Spectrum 128K that turns the modular jacks/knobs/switch into a patchable control surface — plus OneBit (1-bit beeper synth) as an alternate boot mode.<br>[Web editor](https://uglifruit.github.io/WorkshopZX/interface.html) | 1.0.0<br>Released | C++ (Pico SDK / ComputerCard) | Andy Jenkinson (uglifruit) |
...
| 74_Wild_Pebble | MIDI-clockable generative rhythm and melody organism inspired by Pet Rock | 1.0<br>Beta - stable in single-developer testing | C++ | Adrian Vos |
