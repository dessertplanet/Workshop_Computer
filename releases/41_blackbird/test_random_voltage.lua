...
print("DEBUG: About to call input[1].mode('change', 5.0, 0.1, 'rising')")
input[1].mode('change', 5.0, 0.1, 'rising')
...
print("Input 1 threshold: 5.0V (rising edge detection)")
print("Output 1: Random 0-2V on each rising edge")
print("Feed a signal above 5V to input 1 to trigger")
