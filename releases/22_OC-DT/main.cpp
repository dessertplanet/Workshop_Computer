...
public:
	...
	virtual void ProcessSample()
	{
		...
		if (switchPos == Switch::Up)
		{ // Switch Up - Freeze Buffer (Loop entire buffer)
		...
		{ // Switch Middle - 100% Wet (current behavior)
		...
		{ // Switch Down OR Pulse 2 Gate High - Loop/Glitch Mode
